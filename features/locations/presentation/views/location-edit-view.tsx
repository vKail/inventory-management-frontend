...
import { useLocationEditForm } from '../../hooks/use-location-edit-form'
...
export default function LocationEditView() {
  ...
  const { onSubmit } = useLocationEditForm(id)
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              ...
              <BreadcrumbPage>Editar Ubicación</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <h2 className="text-2xl font-bold tracking-tight">Editar Ubicación</h2>
        <p className="text-muted-foreground">Modifica los datos de la ubicación seleccionada.</p>
      </div>
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value={LocationType.MAINTENANCE}>Mantenimiento</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
