...
export default function LocationFormView() {
  ...
  const onSubmit = (data: LocationFormValues) => {
    console.log('Ubicación registrada:', data)
  ...
  return (
    <div className="flex flex-col items-center space-y-6 px-6 md:px-12 w-full">
      <div className="mb-2 w-[1200px] min-w-[1200px] max-w-[1200px] mx-auto">
        ...
        <p className="text-muted-foreground">Complete el formulario para registrar una nueva ubicación en el sistema.</p>
      </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Número o nombre del piso" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" placeholder="Capacidad máxima" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ej: Cajas, Pallets" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" placeholder="Cantidad ocupada" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Latitud, Longitud" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Referencia del lugar" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
