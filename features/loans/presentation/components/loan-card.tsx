...
/**
 * Determina el color CSS para el badge de estado del préstamo
 * @param {Loan} loan - Objeto con la información del préstamo
 * @returns {string} Clase CSS para el color del badge
 * @example
 * getStatusColor(loan) // retorna 'bg-green-100 text-green-800' para préstamos activos
 * getStatusColor(loan) // retorna 'bg-red-100 text-red-800' para préstamos vencidos
 * getStatusColor(loan) // retorna 'bg-gray-100 text-gray-800' para préstamos devueltos
 */
    ...
    <Card className="h-full flex flex-col">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          ...
          <Badge className={getStatusColor(loan)} variant="outline">
