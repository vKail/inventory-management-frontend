...
export const inventorySchema = z.object({
  ...
  entryOrigin: z
    ...
    .max(20, 'El origen de entrada no puede exceder 20 caracteres'),
  entryType: z
    .string()
    .min(1, 'El tipo de entrada es requerido')
    .max(20, 'El tipo de entrada no puede exceder 20 caracteres'),
  ...
  commitmentNumber: z
    .string()
    .min(1, 'El número de compromiso es requerido')
    .max(20, 'El número de compromiso no puede exceder 20 caracteres'),
  modelCharacteristics: z
    .string()
    .min(1, 'Las características del modelo son requeridas')
    .max(20, 'Las características del modelo no pueden exceder 20 caracteres'),
  brandBreedOther: z
    .string()
    .min(1, 'La marca/raza/otro es requerido')
    .max(20, 'La marca/raza/otro no puede exceder 20 caracteres'),
  identificationSeries: z
    .string()
    .min(1, 'La serie de identificación es requerida')
    .max(20, 'La serie de identificación no puede exceder 20 caracteres'),
  warrantyDate: z.date({
  ...
  dimensions: z
    ...
    .max(20, 'Las dimensiones no pueden exceder 20 caracteres'),
  critical: z.boolean(),
  dangerous: z.boolean(),
