...
import { InventoryFilters } from "@/shared/components/inventory/InventoryFilters";
import { ProductCard } from "@/shared/components/inventory/ProductCard";
import { Button } from "@/shared/components/Button";
import { Product, ProductCategory, Department, ProductStatus } from "@/shared/components/inventory/types";
...
export default function InventoryPage() {
  ...
  const handleFilterChange = (newFilters: { category: string; search: string }) => {
    ...
    const filtered = demoProducts.filter(p =>
      ...
      (newFilters.search === "" || p.name.toLowerCase().includes(newFilters.search.toLowerCase()))
    );
    setProducts(filtered);
  };

  const handleLoan = (product: Product) => {
    console.log("Prestar producto:", product);
  };
